...
**Disclaimer**: 
I am not a seasoned developer and the card itself is quite technical as well, which adds challenges to my lack of development skills. As a result I will still try spending time to fix issues that are reasonable i.e. majore and/or no workarounds found. Added to that I asked to add a few PR/issues noted from the source/RomRider and **I can accept PR's if they have been thoroughly tested**
