...
| `unit` | boolean or string | `true` | v1.4.0 | If `show_states` is enabled, this would show/hide the unit of this specific serie in the header. If set to `before_value`, it would display the unit left of the value, e.g. interesting for monetary values|
